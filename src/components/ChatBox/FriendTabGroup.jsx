...
export default function FriendTabGroup(props) {
  ...
  <div className="relative flex-col bg-white py-2 w-14 h-full overflow-hidden">
    <FriendTab onClick={onClick} avatarUrl={"https://images.unsplash.com/photo-1615813967515-e1838c1c5116?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2574&q=80"} />
