...
export default function CardContainer(props) {
  return (
    <div>
      <div className="mt-6 mb-3 mx-6 text-2xl font-bold px-6 text-rose-500">
        {props.children}
      </div>
      <div className="flex overflow-x-scroll whitespace-nowrap min-h-[300px] max-h-[350px] rounded-xl px-7 h-30%">
